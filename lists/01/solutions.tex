...
\author{Funções de Primeiro Grau (10/04/2026)}
\date{}
...
\begin{enumerate}[\bfseries 1.]
  \item Seja a função $p(s)=7+2.5s$, que calcula o preço (R\$), em
    função do espaço(s) percorridos em $km$. Quanto se irá pagar ao
    andar 3 $km$ e 9 $km$.

    \begin{solution}\\
      Preço para 3: $p(3)=7+2.5\cdot 3=7+ 5.5 = 12.5$\\
  ...
  \item Um objeto lançado verticalmente para cima, tem sua velocidade
    ...
    \begin{solution}
      ...
      \begin{enumerate}
        ...
        \item $v(6)=-120$ e $v(14)=36$, ou $120 m/s$ para cima e $36
          m/s$ para baixo, respectivamente.
        \item Quando a velocidade é nula. Ou seja $v(t)=0\implies t=27 s$.
      \end{enumerate}
